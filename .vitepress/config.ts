...
export default defineConfigWithTheme<ThemeConfig>({
  ...
  lang: 'en-US',
  title: 'ad.js',
  description: 'ad.js - The JavaScript Advertisement Framework',
  srcDir: 'src',
  ...
  themeConfig: {
    ...
    socialLinks: [
      ...
      { icon: 'github', link: 'https://github.com/ad-js/ad-site' },
  ...
  markdown: {
    config(md) {
      md.use(headerPlugin as any).use(jobsPlugin as any)
    }
  },
